package tw.edu.ncku.im.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // User is aleady sign in. Display a welcome Toast
    ...
    private void displayChatMessages() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(options) {
            ...
            protected void populateView(View v, ChatMessage model, int position) {
                ...
                //Log.e("MSG",messageText.getText().toString());
            }
        };
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (requestCode == SIGN_IN_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Fail to signed in", Toast.LENGTH_LONG).show();
                finish();
            }
        }
    }
            ...
            AuthUI.getInstance().signOut(this)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(MainActivity.this,"You have been sign out",
                                    Toast.LENGTH_LONG).show();
                        }
                    });
        }
